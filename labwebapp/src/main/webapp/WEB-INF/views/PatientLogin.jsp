    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-center align-items-center m-0" style="height: 100vh;">
            <div class="login_oueter" style="position: absolute;top: 63.2px;">
                <form action="patientlablogin" method="post" autocomplete="off" class="bg-light border p-3">
                    <div class="form-row">
                        <h4 style="position: relative;left: 96px;">Patient Login</h4>
                        <div class="col-12">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-user"></i></span>
                                </div>
                                <input name="patient_email" type="email" class="input form-control" id="email"
                        ...
                        <div class="col-12">
                            <div class="input-group mb-6">
                                ...
                                <input name="patient_password" type="password" class="input form-control" id="password"
