...
<%@ include file="AdminHomeNavBar.jsp"%>
    <div class="container">
        <form action="addThyroidForm" class="form-group" method="post" >
            <h2 style="text-align: center; font-weight: bold; font-family: sans-serif; margin: 20px; color: black;POSITION: relative;
            top: 75px;">
                Enter Thyroid Report</h2>
            <div class="row jumbotron">
                
                <div class="col-md-12" style="margin-top: 15px;">
                    
                    <input type="number" name="t1"  class="form-control" placeholder="TRI IODI Thyronine - T3 Total *" required="required" >mg/dl
                </div>
                <div class="col-md-12" style="margin-top: 15px;">
                    
                    <input type="number" name="t2"  class="form-control" placeholder="Thyroxine - T4 *" >mg/dl
                </div>
                <div class="col-md-12" style="margin-top: 15px;">
                    
                    <input type="number" name="t3"  class="form-control" placeholder="Thyroid Stimulating Harmone(TSH) *"> ulU/ml
                </div>
                 <div class="col-md-12" style="margin-top: 15px;">
